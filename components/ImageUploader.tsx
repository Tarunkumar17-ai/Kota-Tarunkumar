...
const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageUpload, accept = "image/*" }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10">
      <div
        className={`relative border-2 border-dashed border-gray-600 rounded-xl p-8 md:p-16 text-center transition-all duration-300 ${isDragging ? 'border-purple-500 bg-gray-800/50 scale-105' : 'hover:border-purple-400 hover:bg-gray-800'}`}
        onDrop={handleDrop}
